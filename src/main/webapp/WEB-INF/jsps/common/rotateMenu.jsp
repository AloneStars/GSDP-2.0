...
<div class="PathInner" id="PathMenu" style=" margin:250px auto;">
    ...
    <c:if test="${Owner}">
        ...
        <div class="PathItem">
            <a class="link" href="" title="发布动态" onclick="alert('发布动态');">
                <span class="item" style="background-image:url('${pageContext.request.contextPath}/image/menu/moment_icn_info.png');"></span>
            </a>
        </div>
        <div class="PathItem">
            <a class="link" href="" title="发布通知" onclick="alert('发布通知');">
                <span class="item" style="background-image:url('${pageContext.request.contextPath}/image/menu/moment_icn_info.png');"></span>
            </a>
        </div>
        <div class="PathItem">
            <a class="link" href="" title="成员管理" onclick="alert('成员管理');">
                <span class="item" style="background-image: url('${pageContext.request.contextPath}/image/menu/moment_icn_address.png');"></span>
            </a>
        </div>
        <div class="PathItem">
            <a class="link" href="" title="管理员管理" onclick="alert('管理员管理');">
                <span class="item" style="background-image:url('${pageContext.request.contextPath}/image/menu/moment_icn_pic.png');"></span>
            </a>
        </div>
    </c:if>
    ...
    <div class="PathItem">
        <a class="link" href="" title="${Admin}">
            <span class="item" style="background-image: url('${pageContext.request.contextPath}/image/menu/moment_icn_address.png');"></span>
        </a>
    </div>
    <div class="PathItem">
        <a class="link" href="" title="${Member}">
            <span class="item" style="background-image:url('${pageContext.request.contextPath}/image/menu/moment_icn_pic.png');"></span>
        </a>
    </div>
    <div class="PathItem">
