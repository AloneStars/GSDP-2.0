            ...
            <form method="post" class="form-horizontal" role="form" id="create-activity-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="activityName" id="activity-name" placeholder="例如:ACM竞赛" autocomplete="off"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="activityMember" id="activity-member" placeholder="例如:200" autocomplete="off"/>
                            <div class="err-info"></div>
                        </div>
                    ...
                    <div class="form-group" style="margin: 0px; padding: 0px; display: none;">
                        <!-- 加载编辑器的容器 -->
                        <script id="ueditor-container" name="content" type="text/plain">请在此处描述你的活动详情...</script>
                    </div>
                    <!--end of row4-->
